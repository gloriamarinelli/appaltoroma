        ...
        <div class="container mt-5 mb-5">
          <div class="row">
            ...
            >
              ...
              <p>
                {" "}
                Utilizzando le migliori e le più innovative tecnologie presenti
                sul mercato siamo in grando di assicurare:{" "}
              </p>
            ...
            <div class="row" style={{ gap: "50px" }}>
              ...
              >
                ...
                <p>
                  ...
                  impiantistica, tetti in legno massello e lamellare... sistemi
                  di efficentamento
                </p>
              </div>
              ...
              >
                ...
                <p>
                  Pareti ventilate, rivestimenti a cappotto interno ed esterno,
                  sostituzione infissi, verifiche delle trasmittanze tramite
                </p>
              </div>
            </div>
          </div>
              ...
              <div class="row" style={{ gap: "60px" }}>
                <div class="col">
                  ...
                  <h4 style={{ fontStyle: "italic" }}>
                    I continui aggiornamenti a cui ci sottoponiamo costantemente
                    ci garantiscono la più ampia possibilita' di progettare e
                    poi costruire impianti tecnologici e tecnici di qual si
                    voglia carattere e dimensione , sia centralizzati che
                    autonomi per uso civile o industriale tutto certificato a
                    norma di legge e più precisamente: impianti idraulici civili
                    e industriali, impianti di riscaldamento autonomo, impianti
                    di riscaldamento centralizzato, impianti di refrigerazione.
                  </h4>
                  <h1
                    style={{
                      color: "#34aadc",
                ...
                <div class="col">
                  ...
                  <h4 style={{ fontStyle: "italic" }}>
                    ...
                    grandi capannoni industriali o per singole unita abitative o
                    strutture ricettive impianti elettrici civili e industriale
                    impianti domotici protezione anti intrusione
                    videosorveglianza illuminazione eseguiamo anche lavori di
                    impiantistica stradale: illuminazione cablaggi linee
                    elettriche e fibra ottica fognature allacci in fogna
                    impianti di recupero di acque meteoriche impianti di
                    recupero acque grigie civili e industriali.
                  </h4>
                  <h1
                    style={{
                      color: "#34aadc",
